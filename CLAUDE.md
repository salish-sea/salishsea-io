...
- URL state: `d` (date), `x/y/z` (map), `o` (occurrence); profile pages at `/individuals/<7-digit register id>/<designation slug>`, `/matrilines/<id>/<slug>` and `/ecotypes/<id>/<slug>` — only the id is read (decision 034).
