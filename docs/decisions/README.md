...
| [051](051-group-hierarchy-is-the-registers.md) | Which group sits inside which is the register's (`parent_group_id` dropped, read through `group_parents`); the matriarch, an animal's sex, birth years and life status, and parentage stay ours (extends 050, answers the scope of `salish-ox2.5`) | accepted |
