...
| [047](047-orcasite-is-the-moderator-ui.md) | OrcaSound's register-aware tagging is built in orcasite, the moderator UI that stays (Scott Veirs's call); orcasite#1013 accepted in conversation (answers `salish-8vr.22`) | accepted |
| [048](048-sub-matrilines-minted-ahead-of-q22.md) | The register mints the 73 Bigg's sub-lineages ahead of Q22, which now confirms or retires them instead of gating the migration and OrcaSound tagging (amends 035, answers `salish-ox2.6`) | accepted |
