...
**Amended by [034](034-profile-urls-key-on-the-register-identifier.md) (2026-08-30):** `/ecotypes/<designation>` will key on the register `entity_id` with the designation as an ignored slug.
