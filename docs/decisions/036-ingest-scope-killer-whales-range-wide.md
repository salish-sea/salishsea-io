...
- **[CONTEXT.md](../../CONTEXT.md), [PRODUCT.md](../../PRODUCT.md) and the [README](../../README.md)** no longer say spatial scope "matches Acartia's boundaries"; they state the two-part rule, and that it is applied to Maplify today. (The "to Maplify" qualifier came out on 2026-09-18 — see the amended bullet below.)
