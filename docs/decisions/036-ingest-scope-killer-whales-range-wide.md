...
**Status:** accepted; extended to iNaturalist by [044](044-inat-ingest-scope.md) on 2026-09-18 · **Decided:** 2026-08-30 · **Applies:** [008](008-source-schemas-are-upstream-mirrors.md) · **Reconciles with:** [022](022-regions-filter-data.md), [023](023-region-framing-vs-filtering.md) · **Touches:** [027](027-marine-mammal-scope-whale-centric-identity.md)
...
- **[CONTEXT.md](../../CONTEXT.md), [PRODUCT.md](../../PRODUCT.md) and the [README](../../README.md)** no longer say spatial scope "matches Acartia's boundaries"; they state the two-part rule, which applies to both ingested sources ~~, and that it is applied to Maplify today~~ *— the Maplify-only qualifier came out on 2026-09-18 with [044](044-inat-ingest-scope.md); see the amended bullet below.*
- **iNaturalist now has the same rule**, as of [044](044-inat-ingest-scope.md) (2026-09-18): the same predicate over its observations, plus a purge of 51,637 rows — 63% of that mirror, against 35% here. HappyWhale ingest is off.

  *Amended 2026-09-18 (bd `salish-a4y.4`).* That bullet previously read:
  ...
  Both halves of the open question were answered by measuring. The problem was larger than this record guessed — 51,637 rows, not the ~2,150 sea lions [009](009-taxonomic-scope-marine-mammals.md) counted — and the argument against turned out not to be paying for anything: 17,563 pinniped and 4,787 otter records sit inside the box and were untouched, so [027](027-marine-mammal-scope-whale-centric-identity.md)'s unique non-cetacean contribution survives and what went was Californian. The mislabelled constant is now `FETCH_BBOX`, read from `acartiaExtent`.
