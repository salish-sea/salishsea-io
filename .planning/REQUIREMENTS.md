...
- [ ] **LINK-03**: Following an occurrence link sets the date from that occurrence's observed_at timestamp
- [ ] **LINK-04**: Following an occurrence link sets the map center and zoom to that occurrence's location
