...
| 07-03-T1 | 07-03 | 2 | EXPORT-01, EXPORT-03 | T-7-01, T-7-02, T-7-03, T-7-06, T-7-07 | workflow file encodes cron, dispatch, SHA-pins, OIDC, P-02 ordering, guard step, invalidation, assembled DSN from DB_PASSWORD+SUPABASE_PROJECT_ID | static lint | grep assertions in 07-03-PLAN.md Task 1 acceptance_criteria | ❌ → 07-03 creates | ⬜ pending |
