# Requirements Archive: v1.2 Export to DarwinCore Archive
...
- [x] **DWCA-05**: The produced archive passes the GBIF DwC-A validator with no blocking (structural) errors — validated 2026-06-19: "can be indexed by GBIF", zero blocking/structural errors (warnings recorded in 06-06-SUMMARY)
...
| DWCA-05 | Phase 6 | Complete (validated 2026-06-19) |
